# 6. Implement by Claude Teams

Claude Teams 기능을 활용하여 프로토타입을 실제 코드로 구현하는 단계입니다.

## When to Use

- 사용자가 `/6-implement-by-claude-teams` 을 입력했을 때
...
```
✅ Step 6 완료! 앱 구현 + 성장 도구 세팅이 완료되었습니다.

🚀 구현된 기능: {N}개
🔍 SEO 세팅 완료
📊 Analytics 세팅 완료

다음 단계: /7-github-ci-cd-setup 을 입력해주세요.
```
